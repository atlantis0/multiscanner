...
def subscribe():
    ...
    topic_path = subscriber.topic_path(pub_sub_project, pub_sub_topic)
    subscription_name = 'projects/{project_id}/subscriptions/{sub}'.format(project_id=pub_sub_project, sub='wizzy')
...
if __name__ == '__main__':
    ...
    os.environ['GOOGLE_CLOUD_PROJECT'] = 'app-pwned'
